...
public class MainActivity extends AppCompatActivity {
   ...
   private TextView remainingtime,score,countdown;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        gridLayout = findViewById(R.id.gridballoon);

        mediaPlayer = MediaPlayer.create(this,R.raw.balloon_burst);
    ...
    public void increasescoreonClick(View view){
        score1 = score1+1;
    ...
    public void ballooncontrol(){
        ...
        runnable = new Runnable() {
            ...
            public void run() {
                ...
                int number = random.nextInt(balloonsarray.length);
                balloonsarray[number].setVisibility(View.VISIBLE);
    ...
    @Override
    public boolean onCreateOptionsMenu(Menu menu) {  // adding menu speaker button
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        ...
        if(item.getItemId() == R.id.volumemenu){
